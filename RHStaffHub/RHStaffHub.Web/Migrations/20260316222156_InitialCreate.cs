        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeeklyHoursThreshold = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Departments_PrimaryDepartmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsSwapRequested = table.Column<bool>(type: "bit", nullable: false),
                    SwapRequestedToId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CalculatedWage = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TimeEntries_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_PrimaryDepartmentId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shifts_TenantId_DepartmentId_StartTime",
                table: "Shifts",
                columns: new[] { "TenantId", "DepartmentId", "StartTime" });

            migrationBuilder.CreateIndex(
                name: "IX_TimeEntries_DepartmentId",
                table: "TimeEntries",
                column: "DepartmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimeEntries_TenantId_EmployeeId_ClockIn",
                table: "TimeEntries",
                columns: new[] { "TenantId", "EmployeeId", "ClockIn" });
        }
